...
export declare namespace IPancakeV3SwapRouter {
  ...
  export interface IPancakeV3SwapRouterInterface extends Interface {
  ...
  export interface IPancakeV3SwapRouter extends BaseContract {
    
    connect(runner?: ContractRunner | null): IPancakeV3SwapRouter;
    waitForDeployment(): Promise<this>;

    interface: IPancakeV3SwapRouterInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    exactInputSingle: TypedContractMethod<
      [params: IPancakeV3SwapRouter.ExactInputSingleParamsStruct, ],
      [bigint],
      'payable'
    >
