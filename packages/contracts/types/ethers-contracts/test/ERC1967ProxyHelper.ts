...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../common.js"
  ...
  export interface ERC1967ProxyHelperInterface extends Interface {
  ...
  export interface ERC1967ProxyHelper extends BaseContract {
    
    connect(runner?: ContractRunner | null): ERC1967ProxyHelper;
    waitForDeployment(): Promise<this>;

    interface: ERC1967ProxyHelperInterface;
