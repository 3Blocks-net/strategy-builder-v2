...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface MockPancakeV3FactoryInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'setPool', data: BytesLike): Result;
  ...
  export interface MockPancakeV3Factory extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockPancakeV3Factory;
    waitForDeployment(): Promise<this>;

    interface: MockPancakeV3FactoryInterface;
