...
// `satisfies` (not a widening annotation) so the concrete JSON literal types of
// abiFragment/paramSchema are preserved — the seed needs them for Prisma's
// InputJsonValue and the recipe-validation CatalogStepLike shape.
